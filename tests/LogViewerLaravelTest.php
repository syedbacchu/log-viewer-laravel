...
namespace Sdtech\LogViewerLaravel;

use Orchestra\Testbench\TestCase as OrchestraTestCase;
use File;

/**
 * Class LogViewerLaravelTest
 * @package Sdtech\LogViewerLaravel
 */
class LogViewerLaravelTest extends OrchestraTestCase
{
    ...
    public function testSetFile()
    {
        ...
        $laravel_log_viewer = new LogViewerLaravel();
    ...
    {
        $log_viewer = new LogViewerLaravel();
        ob_start();
