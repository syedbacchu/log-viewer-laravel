...
namespace Sdtech\LogViewerLaravel\Controllers;

use Illuminate\Support\Facades\Crypt;
use Sdtech\LogViewerLaravel\Sdtech\LogViewerLaravel\LogViewerLaravel;
 ...
 * @package Sdtech\LogViewerLaravel
 */
class LogViewerLaravelController extends BaseController
{
    /**
    ...
    {
        $this->log_viewer = new LogViewerLaravel();
